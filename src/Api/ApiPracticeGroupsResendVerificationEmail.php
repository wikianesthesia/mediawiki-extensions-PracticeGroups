...
class ApiPracticeGroupsResendVerificationEmail extends ApiPracticeGroupsBaseGet {
    ...
    public function execute() {
        ...
        if( !$practiceGroupsUser ) {
            ...
            $output[ $pgaction ][ 'error' ] = wfMessage( 'practicegroups-error-notfound', wfMessage( 'practicegroups-practicegroupuser' )->text() )->text();
        ...
        $result = $practiceGroupsUser->sendVerificationEmail();
